...
final class SegmentMediaExporterTests: XCTestCase {
    ...
    func testSeparateAndMergedExportCreateMatchingM4AAndBilingualLRCAndSRT() async throws {
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("StudyMate-SegmentExportTests-\(UUID().uuidString)", isDirectory: true)
    ...
    func testIndependentAudioClipStartsAtZeroAndReportsProgress() async throws {
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("StudyMate-IndependentClipTests-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
    ...
    func testLibraryEntryExportReusesIndependentClipsAndWritesLRCAndSRT() async throws {
        ...
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("StudyMate-LibraryExportTests-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: root, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: root) }
