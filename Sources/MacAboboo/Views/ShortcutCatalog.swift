...
public enum MacAbobooShortcutCatalog {
    public static let all: [MacAbobooShortcutDescriptor] = [
        ...
        .init(id: .exportSeparate, chineseName: "逐句导出 M4A 与 LRC/SRT", englishName: "Export Separate M4A and LRC/SRT", keyDisplay: "⌘E"),
        .init(id: .exportMerged, chineseName: "合并导出 M4A 与 LRC/SRT", englishName: "Export Merged M4A and LRC/SRT", keyDisplay: "⌘⇧E"),
