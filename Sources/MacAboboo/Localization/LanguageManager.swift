...
public enum LocalizedKey {
    ...
    var zh: String {
        ...
        case .primaryWaveform: return "主波形图 (全貌/视口)"
        case .secondaryWaveform: return "次波形图 (当前句精细微调)"
        ...
        case .loopModeSingle: return "单句循环"
        case .loopModeAll: return "整曲循环"
        case .loopModePauseAfterSentence: return "句末暂停"
    ...
    var en: String {
        ...
        case .loopModeSingle: return "Loop Sentence"
        case .loopModeAll: return "Loop All"
        case .loopModePauseAfterSentence: return "Pause after sentence"
        case .loopModeNormal: return "Normal Play"
