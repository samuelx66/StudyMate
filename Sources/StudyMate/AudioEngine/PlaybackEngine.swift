...
public final class PlaybackEngine: NSObject, ObservableObject {
    ...
    @Published public var decoderMode: DecoderEngineMode = {
        if let saved = UserDefaults.standard.string(forKey: "StudyMate_DecoderEngineMode"),
    ...
    public func setDecoderMode(_ mode: DecoderEngineMode) {
        ...
        UserDefaults.standard.set(mode.rawValue, forKey: "StudyMate_DecoderEngineMode")
    ...
    /// 加载音视频文件（优先从 ~/Library/Application Support/StudyMate/Projects/ 独立工程文件瞬间读取）
