...
public struct SegmentListView: View {
    ...
    private var regenerateOriginalHelpText: String {
        ...
        return StudyMateShortcutCatalog.help(desc, shortcut: .regenerateOriginalText)
    }
                    ...
                    Button {
                        ...
                        HStack(spacing: 8) {
                            Image(systemName: library.id == currentLibraryID ? "checkmark.circle.fill" : "circle")
                                .foregroundColor(library.id == currentLibraryID ? StudyMateMediaStyle.accent : .secondary)
                                .frame(width: 16)
                            Text(library.name)
                            Spacer(minLength: 0)
                        }
        ...
        HStack(spacing: 0) {
                Button(action: onToggleExportSelection) {
                    Image(systemName: isSelectedForExport ? "checkmark.square.fill" : "square")
                        .font(.system(size: 12))
                        .foregroundColor(isSelectedForExport ? StudyMateMediaStyle.accent : .secondary.opacity(0.45))
                        .frame(width: 18, height: 18)
                }
                .buttonStyle(.plain)
                .segmentListHelp(StudyMateShortcutCatalog.help(
                ...
                VStack(alignment: .leading, spacing: 4) {
                    HStack(spacing: 6) {
                        ...
                        Text("#\(seg.index)")
                            ...
                            .padding(.vertical, 1)
                            .background(isActive ? StudyMateMediaStyle.accent : Color.gray.opacity(0.2))
                                ...
                                HStack(spacing: 4) {
                                    ...
                                    Button(action: onToggleNavigationBookmark) {
                                        Image(systemName: seg.isNavigationBookmarked ? "bookmark.fill" : "bookmark")
                                            .font(.system(size: 9))
                                            .frame(width: 20, height: 20)
                                            .foregroundColor(seg.isNavigationBookmarked ? StudyMateMediaStyle.accent : .secondary)
                                    }
                                    .studymateChromeButton(shape: .circle)
                                    .segmentListHelp(StudyMateShortcutCatalog.help(
                                        lang.text(
