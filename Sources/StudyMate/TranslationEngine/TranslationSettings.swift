...
private final class TranslationKeychainStore: @unchecked Sendable {
    ...
    private let service = "com.studymate.translation"
...
public final class TranslationSettings: ObservableObject {
    ...
    private let enabledKey = "StudyMate.Translation.AutomaticEnabled"
    private let servicesKey = "StudyMate.Translation.Services"
    private let selectedServiceKey = "StudyMate.Translation.SelectedServiceID"
    private let lastTranslationServiceKey = "StudyMate.Translation.LastExecutionServiceID"
    private let lastTranslationTargetLanguageKey = "StudyMate.Translation.LastExecutionTargetLanguage"
